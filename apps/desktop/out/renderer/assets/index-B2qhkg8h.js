      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-tertiary px-2 animate-pulse", children: "Loading agents..." }) : agents.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-tertiary px-2", children: "No agents in squad" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: agents.map((agent, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `w-full flex items-center gap-2.5 px-2 py-1.5 rounded-md text-sm transition-default ${selectedAgent === agent.name ? "bg-bg-active text-text-primary" : "text-text-secondary hover:bg-bg-hover hover:text-text-primary"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate font-medium text-sm", children: agent.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xs text-text-tertiary truncate", children: roleKey ? ROLE_COLORS[roleKey].label : agent.role })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `status-dot status-dot-${agent.status} shrink-0` })
            ]
          }
        ) }, agent.name);
      }) })
...
function BuildingView({ squads, onSelectSquad, loading }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-6 animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-text-primary", children: "Squad Campus" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-text-tertiary ml-2", children: [
        squads.length,
        " building",
        squads.length !== 1 ? "s" : ""
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: squads.map((squad) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
...
function StreamingOutput({ text }) {
  if (!text) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-md text-text-primary whitespace-pre-wrap break-words", children: [
    text,
...
function ChatPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "flex flex-col w-80 min-w-panel-min bg-bg-raised border-l border-border animate-slide-in-right shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-4 py-3 border-b border-border shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-text-primary truncate", children: agentName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "text-2xs font-medium",
            style: { color: roleKey ? ROLE_COLORS[roleKey].text : void 0 },
            children: roleKey ? ROLE_COLORS[roleKey].label : agentRole
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-3 space-y-3 scrollbar-thin", children: [
      !sessionId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center h-full text-center py-12", children: [
      ...
      ] }) : messages.length === 0 && !streamingText ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-tertiary", children: "Send a message to begin." }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `max-w-[85%] rounded-lg px-3 py-2 text-sm ${msg.role === "user" ? "bg-accent text-white" : "bg-bg-surface text-text-primary"}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "whitespace-pre-wrap break-words", children: msg.text })
                }
              )
            ]
          },
        ...
        streamingText && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-start animate-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "flex items-center justify-center rounded-full w-6 h-6 text-2xs font-semibold text-white shrink-0 mr-2 mt-0.5",
    ...
    sessionId && /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, className: "p-3 border-t border-border shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ref: inputRef,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-bg-sunken p-4 overflow-y-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bg-raised border border-border rounded-lg p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-text-primary font-mono", children: safeTokens.toLocaleString() }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bg-raised border border-border rounded-lg p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold font-mono", style: { color: safeCost > 1 ? "#f87171" : "#4ade80" }, children: [
          "$",
          safeCost.toFixed(2)
        ] }),
...
function HooksPanel() {
  ...
  const [loading, setLoading] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const fetchHookActivity = reactExports.useCallback(async () => {
    setLoading(true);
    setError(null);
    try {
      const res = await window.squadAPI.getHookActivity();
      const result = res;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-bg-sunken p-4 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-text-primary flex items-center gap-2", children: "🛡️ Governance Hooks" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 mb-3 text-sm text-status-error bg-status-error/10 rounded border border-status-error/20", children: error }),
    !loading && !error && events.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center flex-1 text-text-tertiary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl mb-2", children: "🛡️" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No governance events yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Hook events will appear as agents work" })
    ] }),
    events.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pl-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-2 top-0 bottom-0 w-px bg-border" }),
      [...events].reverse().map((event) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-4 last:mb-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -left-4 top-2 w-2.5 h-2.5 rounded-full bg-accent border-2 border-bg-sunken" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-text-tertiary font-mono mb-1", children: new Date(event.timestamp).toLocaleTimeString() }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bg-raised border border-border rounded-lg p-3 hover:border-accent/40 transition-default", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-1.5 py-0.5 text-xs font-medium rounded border ${badgeStyles[event.type]}`, children: badgeLabels[event.type] }),
            event.agentName && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-accent", children: event.agentName })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-text-secondary", children: event.description })
        ] })
      ] }, event.id))
    ] })
  ] });
...
function mergeAgentInfo(members, statuses) {
  ...
  return members.map((m2) => {
    const s = statusMap.get(m2.name.toLowerCase());
    return {
      name: m2.name,
      role: m2.role,
      status: s?.status === "busy" ? "working" : s?.status ?? "idle",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-bg text-text-primary overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-4 py-1 bg-bg-raised border-b border-border shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setActivePanel((p2) => p2 === "hooks" ? "none" : "hooks"),
          className: `px-2.5 py-1 text-xs font-medium rounded transition-default ${activePanel === "hooks" ? "bg-accent/20 text-accent border border-accent/40" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover border border-transparent"}`,
          children: "🛡️ Hooks"
        }
      )
    ] }),
